...
function border_container:new(tab)
    ...
    local new_obj = {
        ...
        --
        pages           = {
            top = { x = 0, y = o, width = 0, height = 0, unfold_distance = 0, is_unfold = false },
            bottom = { x = 0, y = o, width = 0, height = 0, unfold_distance = 0, is_unfold = false },
            left = { x = 0, y = o, width = 0, height = 0, unfold_distance = 0, is_unfold = false },
            right = { x = 0, y = o, width = 0, height = 0, unfold_distance = 0, is_unfold = false },
        },
        buttons         = {
            top = { x = 0, y = o, width = 0, height = 0, is_presses = false, is_drag = false },
            bottom = { x = 0, y = o, width = 0, height = 0, is_presses = false, is_drag = false },
            left = { x = 0, y = o, width = 0, height = 0, is_presses = false, is_drag = false },
            right = { x = 0, y = o, width = 0, height = 0, is_presses = false, is_drag = false },
        },
        --页面单独视图排序
        page_children   = {
            main = {},
...
function border_container:_event_intercept(x, y, child)
    ...
    if child then
        ...
        if label then
            ...
            assert(label, child.type .. " 边框布局视图未正确添加独特属性")
        end
    end
    --print(123)
    --默认向下传递
